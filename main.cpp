...
int main(int argc, char *argv[])
{
    ...
    if (isDark) {
        ...
        Utility::setAppQColor("lightestBackground",QColor(39,39,39));
        Utility::setAppQColor("lightBackground",QColor(39,39,39));
        Utility::setAppQColor("normalBackground", QColor(39,39,39));
        ...
        Utility::setAppQColor("lightAccent", QColor(200,0,0));
        ...
        Utility::setAppQColor("midAccent", QColor(143,0,0));
        Utility::setAppQColor("darkAccent", QColor(143,0,0));
